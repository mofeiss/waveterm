...
import { BlockMultiTabCloseConfirm } from "@/app/modals/blockmultitabcloseconfirm";
...
const modalRegistry: { [key: string]: React.ComponentType<any> } = {
    ...
    [BlockMultiTabCloseConfirm.displayName || "BlockMultiTabCloseConfirm"]: BlockMultiTabCloseConfirm,
